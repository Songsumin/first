...
class da1 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
	  ...
	  public da1() {
       ...
       JLabel label = new JLabel("다이나믹치킨"); //가게 명
       ...
       ImageIcon icon = new ImageIcon("D:\\eclipse-workspace\\project\\da11.png");
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\da12.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\da13.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("●  070-4799-1055  ");
       JLabel label2 = new JLabel("● 메뉴 :다이나믹버거 5500 ");
