...
class zzokKorea2 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
     ...
     public zzokKorea2() {
      JPanel panel = new JPanel();
       ...
       JLabel label = new JLabel("우리분식"); //가게 명
       ...
       ImageIcon icon = new ImageIcon("D:\\eclipse-workspace\\project\\dc11.png");
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\zh22.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\zh21.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● ---");
       JLabel label2 = new JLabel("● 순두부찌개, 생삽겹 등 모든 메뉴 5000");
