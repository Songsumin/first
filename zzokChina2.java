...
class zzokChina2 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
     ...
     public zzokChina2() {
      JPanel panel = new JPanel();
       ...
       JLabel label = new JLabel("감래등"); //가게 명
       ...
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\zc22.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\zc21.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● 053-939-9134");
       JLabel label2 = new JLabel("● 메뉴 : 짜장면 5000 현금가로는 2500 칠리탕수육 14000");
