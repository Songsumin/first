...
class dj1 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
	  ...
	  public dj1() {
       ...
       JLabel label = new JLabel("삐떡"); //가게 명
       ...
       ImageIcon icon = new ImageIcon("D:\\eclipse-workspace\\project\\dj11.png");
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\dj12.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\dj13.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● 053-872-9072  ");
       JLabel label2 = new JLabel("● 메뉴 :돼지불고기떡볶이 15000 오리지널 떡볶이 2500");
