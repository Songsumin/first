...
class zzokAma3 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
     ...
     public zzokAma3() {
      JPanel panel = new JPanel();
       ...
       JLabel label = new JLabel("돈가스백작"); //가게 명
       ...
       ImageIcon icon = new ImageIcon("D:\\eclipse-workspace\\project\\ba32.png");
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\za32.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\za31.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● 053-955-0601");
       JLabel label2 = new JLabel("● 메뉴 : 등심돈가스6000 치즈 돈가스 7000");
