...
class dj2 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
	  ...
	  public dj2() {
       ...
       JLabel label = new JLabel("선택떡볶이"); //가게 명
       ...
       ImageIcon icon = new ImageIcon("D:\\eclipse-workspace\\project\\dj21.png");
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\dj22.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\dj23.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● 053-872-9072  ");
       JLabel label2 = new JLabel("● 메뉴 :달볶이, 중볶이,매볶이 등등 2개 골라서 4500 ");
