...
class dc3 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
	  ...
	  public dc3() {
       ...
       JLabel label = new JLabel("용궁"); //가게 명
       ...
       ImageIcon icon = new ImageIcon("D:\\eclipse-workspace\\project\\dc31.png");
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\dc32.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\dc33.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● 053-954-3497  ");
       JLabel label2 = new JLabel("● 메뉴 :짜장면 3500 간짜장 4500  ");
