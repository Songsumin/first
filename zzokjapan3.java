...
class zzokjapan3 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
	  ...
	  public zzokjapan3() {
       ...
       JLabel label = new JLabel("초밥집"); //가게 명
       ...
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\zj32.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\zj31.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● 053-956-0764");
       JLabel label2 = new JLabel("● 메뉴 : 모듬초밥A9000 불초밥 10피스-10000 ");
