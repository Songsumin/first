...
class zzokAma2 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
     ...
     public zzokAma2() {
      JPanel panel = new JPanel();
       ...
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\za22.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\za21.png");
