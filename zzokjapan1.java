...
class zzokjapan1 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
	  ...
	  public zzokjapan1() {
       ...
       JLabel label = new JLabel("열도분식"); //가게 명
       ...
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\zj12.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\zj11.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● 053-955-8253");
       JLabel label2 = new JLabel("● 메뉴 : 모듬초밥 12000 얼큰김치나베 9500 ");
