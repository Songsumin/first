...
class zzokChina3 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
     ...
     public zzokChina3() {
      JPanel panel = new JPanel();
       ...
       JLabel label = new JLabel("짬마담"); //가게 명
       ...
       ImageIcon icon = new ImageIcon("D:\\eclipse-workspace\\project\\bc22.png");
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\zc32.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\zc31.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● 053-944-0534");
       JLabel label2 = new JLabel("● 메뉴 : 차돌박이 ???뽕 7900 찹쌀 탕수육 10900");
