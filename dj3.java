...
class dj3 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
	  ...
	  public dj3() {
       ...
       JLabel label = new JLabel("조아라"); //가게 명
       ...
       ImageIcon icon = new ImageIcon("D:\\eclipse-workspace\\project\\dj31.png");
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\dj32.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\dj33.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● 053-292-5959  ");
       JLabel label2 = new JLabel("● 메뉴 :나만조아 세트(떡볶이1+튀김1+닭강정 소+쿨피스) 8000");
