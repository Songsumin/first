...
class dk1 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
	  ...
	  public dk1() {
       ...
       JLabel label = new JLabel("금상갈비촌"); //가게 명
       ...
       ImageIcon icon = new ImageIcon("D:\\eclipse-workspace\\project\\dk11.png");
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\dk12.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\dk13.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● 053-951-3077");
       JLabel label2 = new JLabel("● 메뉴 : 갈비정식 4000원 ");
