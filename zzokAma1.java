...
class zzokAma1 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
	  ...
	  public zzokAma1() {
       ...
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\za12.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\za11.png");
