...
class zzokKorea1 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
	  ...
	  public zzokKorea1() {
       ...
       JLabel label = new JLabel("종이밥"); //가게 명
       ...
       ImageIcon icon = new ImageIcon("D:\\eclipse-workspace\\project\\zh12.png");
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\zh12.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\zh11.png");
