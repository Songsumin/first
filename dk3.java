...
class dk3 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
	  ...
	  public dk3() {
       ...
       JLabel label = new JLabel("색계"); //가게 명
       ...
       ImageIcon icon = new ImageIcon("D:\\eclipse-workspace\\project\\dk31.png");
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\dk32.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\dk33.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● 053-939-0203 ");
       JLabel label2 = new JLabel("● 메뉴 : 간장 반마리 14000 빨간 반마리 15000 ");
