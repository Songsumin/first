...
class dc1 extends JFrame{ //5번 장면 그냥 예시로 넣은 것 여기에 나중에 추가하기
	  ...
	  public dc1() {
       ...
       JLabel label = new JLabel("경북반점"); //가게 명
       ...
       ImageIcon icon1 = new ImageIcon("D:\\eclipse-workspace\\project\\dc12.png");
       ImageIcon icon2 = new ImageIcon("D:\\eclipse-workspace\\project\\dc13.png");
       button1.setIcon(icon);
       button2.setIcon(icon1);
       button3.setIcon(icon2);
       JLabel label1 = new JLabel("● 053-954-3497  ");
       JLabel label2 = new JLabel("● 메뉴 :경복반점 짜장면 4000 짬뽕 4500 ");
